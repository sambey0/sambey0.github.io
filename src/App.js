...
const navbar = (
  <Navbar fixed='top' variant='dark' style={{ backgroundColor: '#0089A7' }} expand='sm'>
    <Navbar.Brand href='#'>Samarth Batra</Navbar.Brand>
      ...
      <div>
        ...
        <Container fluid={true}>
          <Row id='resume' className='justify-content-md-center'>
            <Col md={10} sm={12}>
              <Button variant='outline-info' href='./assets/Samarth_resume_website_public.pdf' className='my-2 mr-2' download>
        ...
        <footer className='py-5'>
          <Container>
            <ul className='social-links text-center'>
              <li><a target='_blank' rel='noopener noreferrer' href='https://github.com/sambey0' title='GitHub'><FontAwesomeIcon icon={faGithub} /></a></li>
